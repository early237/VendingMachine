 ...
 */
	...
	public String login(String password) { 
		if( password.equals("password")) { // means password is ok. Needs further work! Password shouldn't be hard coded but rather be encrypted etc
	...
	public int authPrintReceipt(String authenticationcookie) { 
		if( authenticationcookie.equals(sessioncookie)) { 
			int result = receiver.printReceiptRMI();
			return result;
		} else { 
			return -1;
		}
